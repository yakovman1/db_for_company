...
async def list_favorites(user: PluginUserContext, session: AsyncSession) -> FavoritesListResponse:
...
async def remove_favorite(user: PluginUserContext, family_id: uuid.UUID, session: AsyncSession) -> None:
